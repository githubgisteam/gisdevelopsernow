...
var MY_SLACK_WEBHOOK_URL = "https://hooks.slack.com/services/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";
...
//                slack.send({				  
  ...
  //              });
                console.log(JSON.stringify({ "Ticket number: " + res[i].number + " and urgency is " + res[i].urgency }));
